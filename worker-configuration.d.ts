/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cd37ff2295316930a3472d37f3b030be)
// Runtime types generated with workerd@1.20260601.1 2026-06-29 nodejs_compat
interface __BaseEnv_Env {
	PENDING_ISSUES: KVNamespace;
	ALLOWED_GUILD_ID: "<DISCORD_GUILD_ID>";
	CHANNEL_REPO_MAP_JSON: "{\"guilds\":{\"<DISCORD_GUILD_ID>\":{\"channels\":{\"<CHANNEL_ID>\":\"owner/repo\"}}}}";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_GUILD_ID" | "CHANNEL_REPO_MAP_JSON" | "OPENAI_MODEL">> {}
}
